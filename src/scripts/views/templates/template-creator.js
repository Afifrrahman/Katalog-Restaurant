...
<div class="list-item" tabindex="0">
  ...
  <img class="list-thumb lazyload" data-src="${restaurant.pictureId ? API_ENDPOINT.IMG.S + restaurant.pictureId : 'https://picsum.photos/id/666/800/450?grayscale'}" alt="${restaurant.name}" crossorigin="anonymous">
</div>
`;
...
<div class="detail-card" tabindex="0">
  ...
  <img class="detail-thumb lazyload" data-src="${restaurant.pictureId ? API_ENDPOINT.IMG.M + restaurant.pictureId : 'https://picsum.photos/id/666/800/450?grayscale'}" alt="${restaurant.name}" crossorigin="anonymous">
